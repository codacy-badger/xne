...
size_t                      send(socket_base::handle_type handle, const char* data, size_t size, std::error_code& ec, socket_base::cflags flags = 0);
size_t                      receive(socket_base::handle_type handle, char* data, size_t size, std::error_code& ec, socket_base::cflags flags = 0);
